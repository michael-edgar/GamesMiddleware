...
namespace Resources.Scripts
{
    public class Launcher : MonoBehaviourPunCallbacks
    {
        ...
        /// <summary>
        /// MonoBehaviour method called on GameObject by Unity during early initialisation phase.
        /// </summary>
        void Awake()
        {
            // #Critical
            // this makes sure we can use PhotoNetwork.LoadLevel() on the master client and all clients in the same room sync their level automatically
        ...
        public void Connect()
        {
            ...
            // we check if we are connected or not, we join if we are, else we initialise the connection to the server.
